...
//        let center =  MainTabViewController();
//        CuClient.sharedInstance.centerViewController = center.viewMain
        let center =  LoginViewController()

        self.window?.thmemChangedHandler = {[weak self] (style) -> Void in
            self?.window?.backgroundColor = CuColor.colors.v2_backgroundColor;
        }
